...
class wButton : public wxWindow
{
public:
    wButton(wxWindow *parent, wxWindowID id, std::string m_text, const wxPoint &pos, const wxSize &size, long style = 0, const wxString &name = wxPanelNameStr)
        : wxWindow(), text(m_text)
    {
        ...
        this->Bind(wxEVT_PAINT, &wButton::OnPaint, this);

        this->Bind(wxEVT_ENTER_WINDOW, &wButton::OnMouseEnter, this);
        this->Bind(wxEVT_LEAVE_WINDOW, &wButton::OnMouseLeave, this);
    }

...
namespace net
{
    ...
    // template <typename T>
    // virtual server_interface<T>::~server_interface()
    // {
    ...
    // template <typename T>
    // void server_interface<T>::MessageAllClients(const message<T> &msg, std::shared_ptr<connection<T>> pIgnoreClient = nullptr)
    // {
    ...
    // template <typename T>
    // virtual bool server_interface<T>::OnClientConnect(std::shared_ptr<connection<T>> client)
    // {
    //     return false;
    // }
    ...
    // template <typename T>
    // virtual void server_interface<T>::OnClientDisconnect(std::shared_ptr<connection<T>> client)
    // {
    // }

    // // Called when a message arrives
    // template <typename T>
    // virtual void server_interface<T>::OnMessage(std::shared_ptr<connection<T>> client, message<T> &msg)
    // {
    // }
